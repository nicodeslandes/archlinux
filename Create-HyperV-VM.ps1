...
New-VM $Name -Generation 2 -MemoryStartupBytes 1GB -SwitchName $VmSwitch -VHDPath $vhd | Out-Null
...
Write-Host "curl -O https://raw.githubusercontent.com/nicodeslandes/archlinux/main/install.sh
chmod +x install.sh
./install.sh <host_name>`n"